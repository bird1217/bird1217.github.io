...
angular.module('ionicApp')
  ...
  return {
    todos: [{"number":1,"eg":"are","ch":"be動詞","txtEnglish":"","txtChinese":"","randomFlag":false}
    ...
    getById: function(todoId) {      
      //this.todos.forEach(fun
	  
	  var filterData=this.todos.filter(function(item) {
		return item.number == todoId;
	 });	
