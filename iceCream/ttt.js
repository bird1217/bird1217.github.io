...
angular.module("ionic-datepicker.provider", []).provider("ionicDatePicker", function() {
    ...
    this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService", function(n, t, a, o) {
        ...
        function c(e) {
            ...
            angular.forEach(e.disabledDates, function(e, n) {
                e = i(new Date(e)),
        ...
        function d(e) {
            ...
            u.monthsList = [],
            u.mainObj.monthsList && 12 === u.mainObj.monthsList.length ? u.monthsList = u.mainObj.monthsList : u.monthsList = o.monthsList,
            u.yearsList = o.getYearsList(u.mainObj.from, u.mainObj.to),
            u.dayList = [];
            var a, c;
            u.firstDayEpoch = i(new Date(e.getFullYear(),e.getMonth(),n)).getTime(),
            u.lastDayEpoch = i(new Date(e.getFullYear(),e.getMonth(),t)).getTime();
            for (var d = n; t >= d; d++)
                a = new Date(e.getFullYear(),e.getMonth(),d),
                c = a.getTime() < u.fromDate || a.getTime() > u.toDate || u.mainObj.disableWeekdays.indexOf(a.getDay()) >= 0,
                u.dayList.push({
                    date: a.getDate(),
                    month: a.getMonth(),
                    year: a.getFullYear(),
            ...
            u.data.currentMonth = u.mainObj.monthsList[e.getMonth()],
            u.data.currentYear = e.getFullYear(),
            u.data.currentMonthSelected = angular.copy(u.data.currentMonth),
            u.currentYearSelected = angular.copy(u.data.currentYear),
            u.numColumns = 7
        }
        function r(e) {
        ...
        u.prevMonth = function() {
            ...
            u.data.currentMonth = u.mainObj.monthsList[u.currentDate.getMonth()],
            u.data.currentYear = u.currentDate.getFullYear(),
            d(u.currentDate)
        }
        ,
        ...
        u.dateSelected = function(e) {
            ...
            "popup" == u.mainObj.templateType.toLowerCase() ? u.popup.close() : l()))
        }
        ,
        ...
        s.openDatePicker = function(n) {
            ...
            delete u.fromDate,
            delete u.toDate,
            u.mainObj = angular.extend({}, e, n),
            u.mainObj.from && (u.fromDate = i(new Date(u.mainObj.from)).getTime()),
            u.mainObj.to && (u.toDate = i(new Date(u.mainObj.to)).getTime()),
            n.disableWeekdays && e.disableWeekdays && (u.mainObj.disableWeekdays = n.disableWeekdays.concat(e.disableWeekdays)),
            r(u.mainObj),
            u.mainObj.closeOnSelect || (a = [{
            ...
            u.mainObj.showTodayButton && a.push({
                ...
                onTap: function(e) {
                    var n = new Date;
                    d(new Date),
                    u.selctedDateEpoch = i(n).getTime(),
...
angular.module("ionic-datepicker.service", []).service("IonicDatepickerService", function() {
    ...
    this.getYearsList = function(e, n) {
        var t = []
          , a = 1900
          , o = 2100;
        a = e ? new Date(e).getFullYear() : a,
        o = n ? new Date(n).getFullYear() : o;
        for (var i = a; o >= i; i++)
            t.push(i);
        return t
    }
